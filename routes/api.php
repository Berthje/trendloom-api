...
Route::get('/category-coupons', [CategoryCouponController::class, 'getAllCategoriesCoupons']);
Route::get('/category-coupons/{id}', [CategoryCouponController::class, 'getCategoriesCouponById']);
Route::post('/category-coupons', [CategoryCouponController::class, 'createCategoriesCoupon']);
Route::put('/category-coupons/{id}', [CategoryCouponController::class, 'updateCategoriesCoupon']);
Route::delete('/category-coupons/{id}', [CategoryCouponController::class, 'deleteCategoriesCoupon']);
